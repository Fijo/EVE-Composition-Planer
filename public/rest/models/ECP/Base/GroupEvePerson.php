...
/**
 * Base class that represents a row from the 'groupeveperson' table.
 *
 * 
 *
* @package    propel.generator.ECP.Base
*/
abstract class GroupEvePerson implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ECP\\Map\\GroupEvePersonTableMap';
    ...
    /**
     * Initializes internal state of ECP\Base\GroupEvePerson object.
     */
    ...
    /**
     * Compares this with another <code>GroupEvePerson</code> instance.  If
     * <code>obj</code> is an instance of <code>GroupEvePerson</code>, delegates to
     * <code>equals(GroupEvePerson)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GroupEvePerson The current object, for fluid interface
     */
     ...
     * @return $this|\ECP\GroupEvePerson The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[GroupEvePersonTableMap::COL_ID] = true;
        }
    ...
    public function setGroupid($v)
    {
        ...
        if ($this->groupid !== $v) {
            $this->groupid = $v;
            $this->modifiedColumns[GroupEvePersonTableMap::COL_GROUPID] = true;
        }
    ...
    public function setGrouppersontypeid($v)
    {
        ...
        if ($this->grouppersontypeid !== $v) {
            ...
            $this->modifiedColumns[GroupEvePersonTableMap::COL_GROUPPERSONTYPEID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[GroupEvePersonTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GroupEvePersonTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GroupEvePersonTableMap::translateFieldName('Groupid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->groupid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GroupEvePersonTableMap::translateFieldName('Grouppersontypeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->grouppersontypeid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GroupEvePersonTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = GroupEvePersonTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ECP\\GroupEvePerson'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGroupEvePersonQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GroupEvePerson::setDeleted()
     * @see GroupEvePerson::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGroupEvePersonQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GroupEvePersonTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GroupEvePersonTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(GroupEvePersonTableMap::COL_GROUPID)) {
            $modifiedColumns[':p' . $index++]  = 'groupId';
        }
        if ($this->isColumnModified(GroupEvePersonTableMap::COL_GROUPPERSONTYPEID)) {
            $modifiedColumns[':p' . $index++]  = 'groupPersonTypeId';
        }
        if ($this->isColumnModified(GroupEvePersonTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO groupeveperson (%s) VALUES (%s)',
    ...
    {
        $pos = GroupEvePersonTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['GroupEvePerson'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GroupEvePerson'][$this->hashCode()] = true;
        $keys = GroupEvePersonTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ECP\GroupEvePerson
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ECP\GroupEvePerson The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupEvePersonTableMap::COL_ID)) {
            $criteria->add(GroupEvePersonTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(GroupEvePersonTableMap::COL_GROUPID)) {
            $criteria->add(GroupEvePersonTableMap::COL_GROUPID, $this->groupid);
        }
        if ($this->isColumnModified(GroupEvePersonTableMap::COL_GROUPPERSONTYPEID)) {
            $criteria->add(GroupEvePersonTableMap::COL_GROUPPERSONTYPEID, $this->grouppersontypeid);
        }
        if ($this->isColumnModified(GroupEvePersonTableMap::COL_NAME)) {
            $criteria->add(GroupEvePersonTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildGroupEvePersonQuery::create();
        $criteria->add(GroupEvePersonTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ECP\GroupEvePerson (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ECP\GroupEvePerson Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGroup(ConnectionInterface $con = null)
    {
        if ($this->aGroup === null && ($this->groupid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGroup->addGroupEvepeople($this);
             */
        }
    ...
    public function getGroupPersonType(ConnectionInterface $con = null)
    {
        if ($this->aGroupPersonType === null && ($this->grouppersontypeid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGroupPersonType->addGroupEvepeople($this);
             */
        }
     ...
     * If this ChildGroupEvePerson is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildGroupEvePerson The current object (for fluent API support)
     */
    public function setGrouppeople(Collection $grouppeople, ConnectionInterface $con = null)
    {
        ...
        foreach ($grouppeopleToDelete as $groupPersonRemoved) {
            $groupPersonRemoved->setGroupEvePerson(null);
        }
    ...
    public function removeGroupPerson(ChildGroupPerson $groupPerson)
    {
        if ($this->getGrouppeople()->contains($groupPerson)) {
            ...
            $groupPerson->setGroupEvePerson(null);
        }
     ...
     * Otherwise if this GroupEvePerson is new, it will return
     * an empty collection; or if this GroupEvePerson has previously
     * been saved, it will retrieve related Grouppeople from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in GroupEvePerson.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(GroupEvePersonTableMap::DEFAULT_STRING_FORMAT);
    }
