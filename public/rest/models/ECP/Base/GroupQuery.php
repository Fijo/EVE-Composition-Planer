...
/**
 * Base class that represents a query for the 'gr0up' table.
 *
 * 
 *
 ...
 * @method     ChildGroupQuery orderByLastcomputed($order = Criteria::ASC) Order by the lastComputed column
 * @method     ChildGroupQuery orderByLastmodified($order = Criteria::ASC) Order by the lastModified column
 *
 * @method     ChildGroupQuery groupById() Group by the id column
 * @method     ChildGroupQuery groupByName() Group by the name column
 * @method     ChildGroupQuery groupByLastcomputed() Group by the lastComputed column
 * @method     ChildGroupQuery groupByLastmodified() Group by the lastModified column
 *
 ...
 *
 * @method     ChildGroupQuery leftJoinGroupEvePerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupEvePerson relation
 * @method     ChildGroupQuery rightJoinGroupEvePerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the GroupEvePerson relation
 * @method     ChildGroupQuery innerJoinGroupEvePerson($relationAlias = null) Adds a INNER JOIN clause to the query using the GroupEvePerson relation
 *
 * @method     ChildGroupQuery leftJoinGroupPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupPerson relation
 * @method     ChildGroupQuery rightJoinGroupPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the GroupPerson relation
 * @method     ChildGroupQuery innerJoinGroupPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the GroupPerson relation
 *
 * @method     ChildGroupQuery leftJoinGroupAccess($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupAccess relation
 * @method     ChildGroupQuery rightJoinGroupAccess($relationAlias = null) Adds a RIGHT JOIN clause to the query using the GroupAccess relation
 * @method     ChildGroupQuery innerJoinGroupAccess($relationAlias = null) Adds a INNER JOIN clause to the query using the GroupAccess relation
 *
 * @method     \ECP\GroupEvePersonQuery|\ECP\GroupPersonQuery|\ECP\GroupAccessQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildGroup findOneByLastcomputed(string $lastComputed) Return the first ChildGroup filtered by the lastComputed column
 * @method     ChildGroup findOneByLastmodified(string $lastModified) Return the first ChildGroup filtered by the lastModified column *
 ...
 * @method     ChildGroup requireOneByLastcomputed(string $lastComputed) Return the first ChildGroup filtered by the lastComputed column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildGroup requireOneByLastmodified(string $lastModified) Return the first ChildGroup filtered by the lastModified column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildGroup[]|ObjectCollection findByLastcomputed(string $lastComputed) Return ChildGroup objects filtered by the lastComputed column
 * @method     ChildGroup[]|ObjectCollection findByLastmodified(string $lastModified) Return ChildGroup objects filtered by the lastModified column
...
abstract class GroupQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ECP\Base\GroupQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\ECP\\Group', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, lastComputed, lastModified FROM gr0up WHERE id = :p0';
        try {
    ...
    public function filterByLastcomputed($lastcomputed = null, $comparison = null)
    {
        if (is_array($lastcomputed)) {
            ...
            if (isset($lastcomputed['min'])) {
                $this->addUsingAlias(GroupTableMap::COL_LASTCOMPUTED, $lastcomputed['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lastcomputed['max'])) {
                $this->addUsingAlias(GroupTableMap::COL_LASTCOMPUTED, $lastcomputed['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupTableMap::COL_LASTCOMPUTED, $lastcomputed, $comparison);
    }
    ...
    public function filterByLastmodified($lastmodified = null, $comparison = null)
    {
        if (is_array($lastmodified)) {
            ...
            if (isset($lastmodified['min'])) {
                $this->addUsingAlias(GroupTableMap::COL_LASTMODIFIED, $lastmodified['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lastmodified['max'])) {
                $this->addUsingAlias(GroupTableMap::COL_LASTMODIFIED, $lastmodified['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupTableMap::COL_LASTMODIFIED, $lastmodified, $comparison);
    }
    ...
    public function filterByGroupEvePerson($groupEvePerson, $comparison = null)
    {
        if ($groupEvePerson instanceof \ECP\GroupEvePerson) {
            return $this
                ->addUsingAlias(GroupTableMap::COL_ID, $groupEvePerson->getGroupid(), $comparison);
    ...
    public function filterByGroupPerson($groupPerson, $comparison = null)
    {
        if ($groupPerson instanceof \ECP\GroupPerson) {
            return $this
                ->addUsingAlias(GroupTableMap::COL_ID, $groupPerson->getGroupid(), $comparison);
    ...
    public function filterByGroupAccess($groupAccess, $comparison = null)
    {
        if ($groupAccess instanceof \ECP\GroupAccess) {
            return $this
                ->addUsingAlias(GroupTableMap::COL_ID, $groupAccess->getGroupid(), $comparison);
