...
/**
 * Base class that represents a row from the 'itemfilterdef' table.
 *
 * 
 *
* @package    propel.generator.ECP.Base
*/
abstract class ItemFilterDef implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ECP\\Map\\ItemFilterDefTableMap';
    ...
    /**
     * Initializes internal state of ECP\Base\ItemFilterDef object.
     */
    ...
    /**
     * Compares this with another <code>ItemFilterDef</code> instance.  If
     * <code>obj</code> is an instance of <code>ItemFilterDef</code>, delegates to
     * <code>equals(ItemFilterDef)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ItemFilterDef The current object, for fluid interface
     */
     ...
     * @return $this|\ECP\ItemFilterDef The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ItemFilterDefTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ItemFilterDefTableMap::COL_NAME] = true;
        }
    ...
    public function setTypeid($v)
    {
        ...
        if ($this->typeid !== $v) {
            $this->typeid = $v;
            $this->modifiedColumns[ItemFilterDefTableMap::COL_TYPEID] = true;
        }
    ...
    public function setMin($v)
    {
        ...
        if ($this->min !== $v) {
            $this->min = $v;
            $this->modifiedColumns[ItemFilterDefTableMap::COL_MIN] = true;
        }
    ...
    public function setMax($v)
    {
        ...
        if ($this->max !== $v) {
            $this->max = $v;
            $this->modifiedColumns[ItemFilterDefTableMap::COL_MAX] = true;
        }
    ...
    public function setMinlength($v)
    {
        ...
        if ($this->minlength !== $v) {
            $this->minlength = $v;
            $this->modifiedColumns[ItemFilterDefTableMap::COL_MINLENGTH] = true;
        }
    ...
    public function setMaxlength($v)
    {
        ...
        if ($this->maxlength !== $v) {
            $this->maxlength = $v;
            $this->modifiedColumns[ItemFilterDefTableMap::COL_MAXLENGTH] = true;
        }
    ...
    public function setDepth($v)
    {
        ...
        if ($this->depth !== $v) {
            $this->depth = $v;
            $this->modifiedColumns[ItemFilterDefTableMap::COL_DEPTH] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ItemFilterDefTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ItemFilterDefTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ItemFilterDefTableMap::translateFieldName('Typeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->typeid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ItemFilterDefTableMap::translateFieldName('Min', TableMap::TYPE_PHPNAME, $indexType)];
            $this->min = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ItemFilterDefTableMap::translateFieldName('Max', TableMap::TYPE_PHPNAME, $indexType)];
            $this->max = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ItemFilterDefTableMap::translateFieldName('Minlength', TableMap::TYPE_PHPNAME, $indexType)];
            $this->minlength = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ItemFilterDefTableMap::translateFieldName('Maxlength', TableMap::TYPE_PHPNAME, $indexType)];
            $this->maxlength = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ItemFilterDefTableMap::translateFieldName('Depth', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = ItemFilterDefTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ECP\\ItemFilterDef'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildItemFilterDefQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ItemFilterDef::setDeleted()
     * @see ItemFilterDef::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildItemFilterDefQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ItemFilterDefTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_TYPEID)) {
            $modifiedColumns[':p' . $index++]  = 'typeId';
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_MIN)) {
            $modifiedColumns[':p' . $index++]  = 'min';
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_MAX)) {
            $modifiedColumns[':p' . $index++]  = 'max';
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_MINLENGTH)) {
            $modifiedColumns[':p' . $index++]  = 'minlength';
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_MAXLENGTH)) {
            $modifiedColumns[':p' . $index++]  = 'maxlength';
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_DEPTH)) {
            $modifiedColumns[':p' . $index++]  = 'depth';
        }

        $sql = sprintf(
            'INSERT INTO itemfilterdef (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'max':                        
                        ...
                        break;
                    case 'minlength':                        
                        $stmt->bindValue($identifier, $this->minlength, PDO::PARAM_INT);
                        break;
                    case 'maxlength':                        
    ...
    {
        $pos = ItemFilterDefTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ItemFilterDef'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ItemFilterDef'][$this->hashCode()] = true;
        $keys = ItemFilterDefTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            ...
            $keys[3] => $this->getMin(),
            $keys[4] => $this->getMax(),
            $keys[5] => $this->getMinlength(),
            $keys[6] => $this->getMaxlength(),
            $keys[7] => $this->getDepth(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setMin($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setMax($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setMinlength($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setMaxlength($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setDepth($arr[$keys[7]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ECP\ItemFilterDef The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_NAME)) {
            $criteria->add(ItemFilterDefTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_TYPEID)) {
            $criteria->add(ItemFilterDefTableMap::COL_TYPEID, $this->typeid);
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_MIN)) {
            $criteria->add(ItemFilterDefTableMap::COL_MIN, $this->min);
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_MAX)) {
            $criteria->add(ItemFilterDefTableMap::COL_MAX, $this->max);
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_MINLENGTH)) {
            $criteria->add(ItemFilterDefTableMap::COL_MINLENGTH, $this->minlength);
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_MAXLENGTH)) {
            $criteria->add(ItemFilterDefTableMap::COL_MAXLENGTH, $this->maxlength);
        }
        if ($this->isColumnModified(ItemFilterDefTableMap::COL_DEPTH)) {
            $criteria->add(ItemFilterDefTableMap::COL_DEPTH, $this->depth);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ECP\ItemFilterDef (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ECP\ItemFilterDef Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aType === null && ($this->typeid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aType->addItemFilterDefs($this);
             */
        }
     ...
     * If this ChildItemFilterDef is new, it will return
    ...
    public function setItemFilterRules(Collection $itemFilterRules, ConnectionInterface $con = null)
    {
        ...
        foreach ($itemFilterRulesToDelete as $itemFilterRuleRemoved) {
            $itemFilterRuleRemoved->setItemFilterDef(null);
        }
    ...
    protected function doAddItemFilterRule(ChildItemFilterRule $itemFilterRule)
    {
        ...
        $itemFilterRule->setItemFilterDef($this);
    }
     ...
     * Otherwise if this ItemFilterDef is new, it will return
     * an empty collection; or if this ItemFilterDef has previously
     * been saved, it will retrieve related ItemFilterRules from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ItemFilterDef.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildItemFilterRule[] List of ChildItemFilterRule objects
     */
    public function getItemFilterRulesJoinFittingRuleRow(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildItemFilterRuleQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ItemFilterDefTableMap::DEFAULT_STRING_FORMAT);
    }
