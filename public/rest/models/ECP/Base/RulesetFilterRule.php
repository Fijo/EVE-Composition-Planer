...
/**
 * Base class that represents a row from the 'rulesetfilterrule' table.
 *
 * 
 *
* @package    propel.generator.ECP.Base
*/
abstract class RulesetFilterRule implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ECP\\Map\\RulesetFilterRuleTableMap';
    ...
    /**
     * The value for the rulesetrulerowid field.
     * @var        int
     */
    protected $rulesetrulerowid;
    ...
    /**
     * @var        ChildRulesetRuleRow
     */
    protected $aRulesetRuleRow;
    ...
    /**
     * Initializes internal state of ECP\Base\RulesetFilterRule object.
     */
    ...
    /**
     * Compares this with another <code>RulesetFilterRule</code> instance.  If
     * <code>obj</code> is an instance of <code>RulesetFilterRule</code>, delegates to
     * <code>equals(RulesetFilterRule)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|RulesetFilterRule The current object, for fluid interface
     */
    ...
    /**
     * Get the [rulesetrulerowid] column value.
     * 
     * @return int
     */
    public function getRulesetrulerowid()
    {
        return $this->rulesetrulerowid;
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RulesetFilterRuleTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [rulesetrulerowid] column.
     * 
     * @param int $v new value
     * @return $this|\ECP\RulesetFilterRule The current object (for fluent API support)
     */
    public function setRulesetrulerowid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->rulesetrulerowid !== $v) {
            $this->rulesetrulerowid = $v;
            $this->modifiedColumns[RulesetFilterRuleTableMap::COL_RULESETRULEROWID] = true;
        }

        if ($this->aRulesetRuleRow !== null && $this->aRulesetRuleRow->getId() !== $v) {
            $this->aRulesetRuleRow = null;
        }
    ...
    public function setInd3x($v)
    {
        ...
        if ($this->ind3x !== $v) {
            $this->ind3x = $v;
            $this->modifiedColumns[RulesetFilterRuleTableMap::COL_IND3X] = true;
        }
    ...
    public function setConcatenation($v)
    {
        ...
        if ($this->concatenation !== $v) {
            ...
            $this->modifiedColumns[RulesetFilterRuleTableMap::COL_CONCATENATION] = true;
        }
    ...
    public function setFittingruleentityid($v)
    {
        ...
        if ($this->fittingruleentityid !== $v) {
            ...
            $this->modifiedColumns[RulesetFilterRuleTableMap::COL_FITTINGRULEENTITYID] = true;
        }
    ...
    public function setComparison($v)
    {
        ...
        if ($this->comparison !== $v) {
            $this->comparison = $v;
            $this->modifiedColumns[RulesetFilterRuleTableMap::COL_COMPARISON] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[RulesetFilterRuleTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RulesetFilterRuleTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RulesetFilterRuleTableMap::translateFieldName('Rulesetrulerowid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rulesetrulerowid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RulesetFilterRuleTableMap::translateFieldName('Ind3x', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ind3x = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RulesetFilterRuleTableMap::translateFieldName('Concatenation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->concatenation = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : RulesetFilterRuleTableMap::translateFieldName('Fittingruleentityid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fittingruleentityid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : RulesetFilterRuleTableMap::translateFieldName('Comparison', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comparison = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : RulesetFilterRuleTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = RulesetFilterRuleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ECP\\RulesetFilterRule'), 0, $e);
        }
    }
    ...
    {
        if ($this->aRulesetRuleRow !== null && $this->rulesetrulerowid !== $this->aRulesetRuleRow->getId()) {
            $this->aRulesetRuleRow = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRulesetFilterRuleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see RulesetFilterRule::setDeleted()
     * @see RulesetFilterRule::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRulesetFilterRuleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RulesetFilterRuleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_RULESETRULEROWID)) {
            $modifiedColumns[':p' . $index++]  = 'rulesetRuleRowId';
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_IND3X)) {
            $modifiedColumns[':p' . $index++]  = 'ind3x';
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_CONCATENATION)) {
            $modifiedColumns[':p' . $index++]  = 'concatenation';
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_FITTINGRULEENTITYID)) {
            $modifiedColumns[':p' . $index++]  = 'fittingRuleEntityId';
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_COMPARISON)) {
            $modifiedColumns[':p' . $index++]  = 'comparison';
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }

        $sql = sprintf(
            'INSERT INTO rulesetfilterrule (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':                        
                        ...
                        break;
                    case 'rulesetRuleRowId':                        
                        $stmt->bindValue($identifier, $this->rulesetrulerowid, PDO::PARAM_INT);
                        break;
                    case 'ind3x':                        
    ...
    {
        $pos = RulesetFilterRuleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getRulesetrulerowid();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getRulesetrulerowid(),
            $keys[2] => $this->getInd3x(),
            $keys[3] => $this->getConcatenation(),
            $keys[4] => $this->getFittingruleentityid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ECP\RulesetFilterRule
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setRulesetrulerowid($value);
                break;
            case 2:
                $this->setInd3x($value);
                break;
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setRulesetrulerowid($arr[$keys[1]]);
        }
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setFittingruleentityid($arr[$keys[4]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ECP\RulesetFilterRule The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_RULESETRULEROWID)) {
            $criteria->add(RulesetFilterRuleTableMap::COL_RULESETRULEROWID, $this->rulesetrulerowid);
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_IND3X)) {
            $criteria->add(RulesetFilterRuleTableMap::COL_IND3X, $this->ind3x);
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_CONCATENATION)) {
            $criteria->add(RulesetFilterRuleTableMap::COL_CONCATENATION, $this->concatenation);
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_FITTINGRULEENTITYID)) {
            $criteria->add(RulesetFilterRuleTableMap::COL_FITTINGRULEENTITYID, $this->fittingruleentityid);
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_COMPARISON)) {
            $criteria->add(RulesetFilterRuleTableMap::COL_COMPARISON, $this->comparison);
        }
        if ($this->isColumnModified(RulesetFilterRuleTableMap::COL_VALUE)) {
            $criteria->add(RulesetFilterRuleTableMap::COL_VALUE, $this->value);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ECP\RulesetFilterRule (or compatible) type.
    ...
    {
        $copyObj->setRulesetrulerowid($this->getRulesetrulerowid());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ECP\RulesetFilterRule Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Get the associated ChildRulesetRuleRow object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildRulesetRuleRow The associated ChildRulesetRuleRow object.
     * @throws PropelException
     */
    public function getRulesetRuleRow(ConnectionInterface $con = null)
    {
        if ($this->aRulesetRuleRow === null && ($this->rulesetrulerowid !== null)) {
            $this->aRulesetRuleRow = ChildRulesetRuleRowQuery::create()->findPk($this->rulesetrulerowid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRulesetRuleRow->addRulesetFilterRules($this);
             */
        }

        return $this->aRulesetRuleRow;
    }
    ...
    public function setconcatenationObj(ChildComparison $v = null)
    {
        ...
        if ($v !== null) {
            $v->addRulesetFilterRuleRelatedByConcatenation($this);
        }
    ...
    public function getconcatenationObj(ConnectionInterface $con = null)
    {
        if ($this->aconcatenationObj === null && ($this->concatenation !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aconcatenationObj->addRulesetFilterRulesRelatedByConcatenation($this);
             */
        }
    ...
    public function setcomparisonObj(ChildComparison $v = null)
    {
        ...
        // If this object has already been added to the ChildComparison object, it will not be re-added.
        if ($v !== null) {
            $v->addRulesetFilterRuleRelatedByComparison($this);
        }
    ...
    public function getcomparisonObj(ConnectionInterface $con = null)
    {
        if ($this->acomparisonObj === null && ($this->comparison !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->acomparisonObj->addRulesetFilterRulesRelatedByComparison($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(RulesetFilterRuleTableMap::DEFAULT_STRING_FORMAT);
    }
