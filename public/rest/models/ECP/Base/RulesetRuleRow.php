...
/**
 * Base class that represents a row from the 'rulesetrulerow' table.
 *
 * 
 *
* @package    propel.generator.ECP.Base
*/
abstract class RulesetRuleRow implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ECP\\Map\\RulesetRuleRowTableMap';
    ...
    /**
     * Initializes internal state of ECP\Base\RulesetRuleRow object.
     */
    ...
    /**
     * Compares this with another <code>RulesetRuleRow</code> instance.  If
     * <code>obj</code> is an instance of <code>RulesetRuleRow</code>, delegates to
     * <code>equals(RulesetRuleRow)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|RulesetRuleRow The current object, for fluid interface
     */
     ...
     * @return $this|\ECP\RulesetRuleRow The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RulesetRuleRowTableMap::COL_ID] = true;
        }
    ...
    public function setRulesetentityid($v)
    {
        ...
        if ($this->rulesetentityid !== $v) {
            ...
            $this->modifiedColumns[RulesetRuleRowTableMap::COL_RULESETENTITYID] = true;
        }
    ...
    public function setInd3x($v)
    {
        ...
        if ($this->ind3x !== $v) {
            $this->ind3x = $v;
            $this->modifiedColumns[RulesetRuleRowTableMap::COL_IND3X] = true;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[RulesetRuleRowTableMap::COL_MESSAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RulesetRuleRowTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RulesetRuleRowTableMap::translateFieldName('Rulesetentityid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rulesetentityid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RulesetRuleRowTableMap::translateFieldName('Ind3x', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ind3x = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RulesetRuleRowTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = RulesetRuleRowTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ECP\\RulesetRuleRow'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRulesetRuleRowQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see RulesetRuleRow::setDeleted()
     * @see RulesetRuleRow::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRulesetRuleRowQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RulesetRuleRowTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RulesetRuleRowTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(RulesetRuleRowTableMap::COL_RULESETENTITYID)) {
            $modifiedColumns[':p' . $index++]  = 'rulesetEntityId';
        }
        if ($this->isColumnModified(RulesetRuleRowTableMap::COL_IND3X)) {
            $modifiedColumns[':p' . $index++]  = 'ind3x';
        }
        if ($this->isColumnModified(RulesetRuleRowTableMap::COL_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'message';
        }

        $sql = sprintf(
            'INSERT INTO rulesetrulerow (%s) VALUES (%s)',
    ...
    {
        $pos = RulesetRuleRowTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['RulesetRuleRow'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RulesetRuleRow'][$this->hashCode()] = true;
        $keys = RulesetRuleRowTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getRulesetentityid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ECP\RulesetRuleRow
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setRulesetentityid($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ECP\RulesetRuleRow The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RulesetRuleRowTableMap::COL_ID)) {
            $criteria->add(RulesetRuleRowTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(RulesetRuleRowTableMap::COL_RULESETENTITYID)) {
            $criteria->add(RulesetRuleRowTableMap::COL_RULESETENTITYID, $this->rulesetentityid);
        }
        if ($this->isColumnModified(RulesetRuleRowTableMap::COL_IND3X)) {
            $criteria->add(RulesetRuleRowTableMap::COL_IND3X, $this->ind3x);
        }
        if ($this->isColumnModified(RulesetRuleRowTableMap::COL_MESSAGE)) {
            $criteria->add(RulesetRuleRowTableMap::COL_MESSAGE, $this->message);
        }
    ...
    {
        $criteria = ChildRulesetRuleRowQuery::create();
        $criteria->add(RulesetRuleRowTableMap::COL_ID, $this->id);
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ECP\RulesetRuleRow Clone of current object.
     * @throws PropelException
     */
    ...
    public function getRulesetEntity(ConnectionInterface $con = null)
    {
        if ($this->aRulesetEntity === null && ($this->rulesetentityid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aRulesetEntity->addRulesetRuleRows($this);
             */
        }
     ...
     * If this ChildRulesetRuleRow is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildRulesetRuleRow The current object (for fluent API support)
     */
    public function setRulesetFilterRules(Collection $rulesetFilterRules, ConnectionInterface $con = null)
    {
        ...
        foreach ($rulesetFilterRulesToDelete as $rulesetFilterRuleRemoved) {
            $rulesetFilterRuleRemoved->setRulesetRuleRow(null);
        }
    ...
    protected function doAddRulesetFilterRule(ChildRulesetFilterRule $rulesetFilterRule)
    {
        ...
        $rulesetFilterRule->setRulesetRuleRow($this);
    }
    ...
    public function removeRulesetFilterRule(ChildRulesetFilterRule $rulesetFilterRule)
    {
        if ($this->getRulesetFilterRules()->contains($rulesetFilterRule)) {
            ...
            $rulesetFilterRule->setRulesetRuleRow(null);
        }
     ...
     * Otherwise if this RulesetRuleRow is new, it will return
     * an empty collection; or if this RulesetRuleRow has previously
     * been saved, it will retrieve related RulesetFilterRules from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RulesetRuleRow.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildRulesetFilterRule[] List of ChildRulesetFilterRule objects
     */
    public function getRulesetFilterRulesJoinFittingRuleEntity(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildRulesetFilterRuleQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aRulesetEntity) {
            $this->aRulesetEntity->removeRulesetRuleRow($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(RulesetRuleRowTableMap::DEFAULT_STRING_FORMAT);
    }
