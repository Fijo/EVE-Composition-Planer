...
class TypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ECP.Map.TypeTableMap';
     ...
     */
    const OM_CLASS = '\\ECP\\Type';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ECP.Type';
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('ItemFilterDef', '\\ECP\\ItemFilterDef', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':typeId',
    1 => ':id',
  ),
), null, null, 'ItemFilterDefs', false);
        $this->addRelation('Comparison', '\\ECP\\Comparison', RelationMap::MANY_TO_MANY, array(), null, null, 'Comparisons');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ECP\Type) { // it's a model object
